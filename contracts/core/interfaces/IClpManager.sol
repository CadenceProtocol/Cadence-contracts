...
interface IClpManager {
    ...
    function removeLiquidity(address _tokenOut, uint256 _clpAmount, uint256 _minOut, address _receiver) external returns (uint256);
    function removeLiquidityForAccount(address _account, address _tokenOut, uint256 _clpAmount, uint256 _minOut, address _receiver) external returns (uint256);
