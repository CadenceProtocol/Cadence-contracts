...
contract ClpManager is ReentrancyGuard, Governable, IClpManager {
    ...
    uint256 public constant CLP_PRECISION = 10 ** 18;
    ...
    function setCooldownDuration(
        ...
        require(
            ...
            "ClpManager: invalid _cooldownDuration"
        );
        cooldownDuration = _cooldownDuration;
    }
    ...
    function addLiquidity(
        ...
        if (inPrivateMode) {
            revert("ClpManager: action not enabled");
        }
        return
            _addLiquidity(
                msg.sender,
    ...
    function getPrice(bool _maximise) external view returns (uint256) {
        ...
        return aum.mul(CLP_PRECISION).div(supply);
    }
    ...
    function _addLiquidity(
        ...
        uint256 mintAmount = aumInUsdg == 0
            ? usdgAmount
            : usdgAmount.mul(clpSupply).div(aumInUsdg);
    ...
    function _removeLiquidity(
        ...
        require(
            ...
            "ClpManager: cooldown duration not yet passed"
        );
